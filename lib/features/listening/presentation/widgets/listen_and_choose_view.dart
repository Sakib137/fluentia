...
/// Interactive UI for Listen & Choose activities.
class ListenAndChooseView extends ConsumerWidget {
      ...
      children: [
        ...
        ...List.generate(activity.options.length, (index) {
          ...
          final isCorrectAnswer =
              ...
              activity.correctAnswer!.toLowerCase() == option.toLowerCase();
          ...
          if (!isSubmitted) {
            ...
            // Submitted feedback colors with accessibility icons
            if (isCorrectAnswer) {
              cardBg = isDark
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        state.isCorrect ? 'Well Done!' : 'Explanation',
                        style: TextStyle(
                          fontSize: AppFontSizes.bodyMedium,
                          fontWeight: AppFontWeights.bold,
                          color: state.isCorrect
