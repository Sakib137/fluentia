...
class PracticeIntroScreen extends ConsumerStatefulWidget {
  const PracticeIntroScreen({super.key, required this.skillId});

  final String skillId;

  @override
  ConsumerState<PracticeIntroScreen> createState() =>
      _PracticeIntroScreenState();
}
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref
          ...
          .initializeSession(skill: _skill);
    });
  }
