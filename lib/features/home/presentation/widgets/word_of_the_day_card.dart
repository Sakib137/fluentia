...
class WordOfTheDayCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final word = wordAsync.value ?? WordOfTheDaySelector.selectWord(DateTime.now());
                      ...
                      children: [
                        Expanded(
                          child: SecondaryButton(
                            text: word.isSaved ? 'Saved to Vocabulary' : 'Save Word',
                            icon: Icon(
                              word.isSaved
                            ...
                            onPressed: () {
                              ref.read(wordOfTheDayProvider.notifier).toggleBookmark();
                            },
                          ),
                        ),
                        const SizedBox(width: AppSpacing.sm),
