...
/// Bundled curated vocabulary dataset for offline Word of the Day and dictionary lookups.
/// Contains authentic words covering CEFR levels A1 to C1.
const List<WordOfTheDay> kCuratedVocabularyList = [
  WordOfTheDay(
    id: 'vocab-01',
    word: 'articulate',
  ...
  WordOfTheDay(
    ...
    phonetic: '/kənˈsaɪs/',
    partOfSpeech: 'adjective',
    definition: 'Giving a lot of information clearly and in very few words.',
    example: 'Her summary was clear, concise, and straight to the point.',
    cefrLevel: 'B1',
  ),
  WordOfTheDay(
    id: 'vocab-09',
  ...
  WordOfTheDay(
    ...
    phonetic: '/ˈluː.sɪd/',
    partOfSpeech: 'adjective',
    definition: 'Expressed clearly; easy to understand; fully intelligible.',
    example: 'The teacher provided a lucid explanation of conditional clauses.',
    cefrLevel: 'B2',
  ),
  WordOfTheDay(
    id: 'vocab-15',
  ...
  WordOfTheDay(
    ...
    phonetic: '/ˈfɑː.stɚ/',
    partOfSpeech: 'verb',
    definition: 'To encourage the development or growth of ideas or skills.',
    example: 'Daily reading habits foster a much richer vocabulary naturally.',
    cefrLevel: 'B2',
  ),
  WordOfTheDay(
    id: 'vocab-17',
  ...
  WordOfTheDay(
    ...
    partOfSpeech: 'noun',
    definition: 'The rise and fall of the voice in pitch when speaking.',
    example: 'English questions typically end with a rising intonation.',
    cefrLevel: 'B1',
  ),
  WordOfTheDay(
    id: 'vocab-25',
